      ...
      <section className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-zinc max-w-none prose-headings:font-serif prose-headings:font-medium prose-headings:text-zinc-900 prose-h3:text-2xl prose-h3:mt-14 prose-h3:mb-6 prose-h3:tracking-tight prose-p:text-zinc-600 prose-p:leading-relaxed prose-p:mb-8 prose-li:text-zinc-600 prose-li:leading-relaxed marker:text-brand-green prose-a:text-brand-green hover:prose-a:text-brand-green-light prose-a:transition-colors prose-strong:text-zinc-900 prose-strong:font-medium">
            ...
            <ul className="space-y-4 my-6">
              <li><strong>Contact Form Submissions</strong> &mdash; Processed under <em>Legitimate Interest</em> and <em>Contractual Necessity</em> to respond to your specific inquiries.</li>
              <li><strong>Email Follow-up Communications</strong> &mdash; Processed under <em>Legitimate Interest</em> to provide relevant business updates (with a right to opt out).</li>
              <li><strong>Analytics & Cookies</strong> &mdash; Processed strictly under <em>Consent</em> obtained via our Cookie Banner.</li>
            </ul>
            ...
            <ul className="space-y-4 my-6">
              <li><strong>Contact Form Data</strong> &mdash; Retained for <strong>12 months</strong> after the inquiry is resolved, after which it is securely deleted.</li>
              <li><strong>Email Correspondence</strong> &mdash; Retained for up to <strong>7 years</strong> solely to comply with legal, tax, and business record-keeping obligations.</li>
              <li><strong>Cookie/Analytics Data</strong> &mdash; Retained per the cookie provider's default term or until you clear your browser cache/preferences.</li>
            </ul>
            ...
            <ul className="space-y-4 my-6">
              <li><strong>Unsubscribe Link</strong> &mdash; Every marketing or promotional email we send contains a clear unsubscribe link at the bottom.</li>
              <li><strong>Timeframe</strong> &mdash; Opt-out requests are honored promptly and within <strong>10 business days</strong> in compliance with the CAN-SPAM Act.</li>
              <li><strong>Manual Opt-Out</strong> &mdash; You may opt out by emailing <a href="mailto:contact@springer.capital">contact@springer.capital</a> with the subject line "Unsubscribe".</li>
              <li><strong>Suppression</strong> &mdash; Once opted out, your email address will be placed on a suppression list to guarantee you do not receive future marketing communications.</li>
            </ul>

            <h3>5. Cookies and Tracking Technologies</h3>
            <p>We use cookies to improve your browsing experience. Types of cookies used include:</p>
            <ul className="space-y-4 my-6">
              <li><strong>Essential Cookies</strong> &mdash; Required for basic site functionality.</li>
              <li><strong>Analytics/Performance Cookies</strong> &mdash; Used to understand site traffic (provided by services such as Google Analytics).</li>
            </ul>
            ...
            <ul className="space-y-4 my-6">
              <li><strong>formsubmit.co</strong> &mdash; Handles routing for our website contact forms. Data is securely relayed through their infrastructure. Please review the <a href="https://formsubmit.co/privacy.pdf" target="_blank" rel="noopener">FormSubmit Privacy Policy</a>.</li>
              <li><strong>Amazon Web Services (SES)</strong> &mdash; Utilized to securely transmit email communications. Please refer to the <a href="https://aws.amazon.com/privacy/" target="_blank" rel="noopener">AWS Privacy Notice</a>.</li>
            </ul>
